...
(() => {
  ...
  const messages = {
    en: {
      ...
      "card.node": "Current node", "card.egress": "Tunnel egress", "card.proxy": "Proxy port", "card.uptime": "Uptime", "card.proxySub": "HTTP + SOCKS5 · Single port", "blacklist.count": "{count} node(s) blacklisted",
